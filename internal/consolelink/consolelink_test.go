...
func TestURL_DeepLinks(t *testing.T) {
	cases := []struct {
		...
		{"lambda layer", model.Resource{Service: "lambda", Type: "layer", Region: "us-east-1", Name: "deps"},
			"/lambda/home?region=us-east-1#/layers/deps"},
		{"lambda event source", model.Resource{Service: "lambda", Type: "event-source-mapping", Region: "us-east-1", ID: "uuid-1"},
			"/lambda/home?region=us-east-1#/functions"},
